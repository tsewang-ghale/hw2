...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newAwardModal">
...
<!-- Modal -->
<div class="modal fade" id="newAwardModal" tabindex="-1" aria-labelledby="newAwardModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="newAwardModalLabel">New Award</h1>
      ...
      <div class="modal-body">
        <form method="post" action="">
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="award_id" name="award_id">
          </div>
          <div class="mb-3">
