...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editAwardModal<?php echo $award['award_id']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editAwardModal<?php echo $award['award_id']; ?>" tabindex="-1" aria-labelledby="editAwardModalLabel<?php echo $award['award_id']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editAwardModalLabel<?php echo $award['award_id']; ?>">Edit Award</h1>
